...
expression is evaluated again. The initialize, test, and update steps are the three
...
expressions must have side effects. initialize is typically an assignment expres‐
sion, while update is usually an increment, decrement, or some other assignment.
...
60 | Chapter 2: Java Syntax from the Ground Up
